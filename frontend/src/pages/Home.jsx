...
const Home = () => {
    ...
    useEffect(() => {
        ...
        axios.get('http://localhost:5555/books')
            .then((response) => {
                setBooks(response.data.data); //response.data is the object received from backend and .data is the 2nd attribute of our json
                setLoading(false);
            })
            .catch((e) => {
                console.log(e);
    ...
    return (
        <div className="p-4">
            ...
            {loading ? (
                ...
                showType === 'table' ? (<BooksTable books={books}></BooksTable>) : (<BooksCard books={books}></BooksCard>)
            )}
        </div>
    )
}
